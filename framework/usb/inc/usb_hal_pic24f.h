...
//IEC0-IEC7 on PIC24FJ256GB412 Family devices
    ...
    #define USB_HAL_VBUSTristate()    {TRISFbits.TRISF7 = 1;}  // <-- replace the "x" characters with the correct values for the VBUS GPIO pin (if the microcontroller selected has GPIO functionality on VBUS)
#endif
